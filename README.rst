...
.. csv-table::
    ...
    Dockerfile.scratch-minimal,Minimal Python image with almost no libraries from scratch,7.27 MB,3.13.0
    Dockerfile.scratch-full,Smallest Python image with default libraries from scratch,22.92 MB,3.13.0
    ...
    Dockerfile.alpine,Alpine-based,48.19 MB,3.13.0
    Dockerfile.ubuntu,Ubuntu-based,116.7 MB,3.13.0
